...
def create_system_model(plant, scene_graph):
    ...
    gripper_ids = [plant.GetCollisionGeometriesForBody(
        body)[0] for body in gripper_bodies]
    arm_ids = [plant.GetCollisionGeometriesForBody(
        body)[0] for body in arm_bodies]
