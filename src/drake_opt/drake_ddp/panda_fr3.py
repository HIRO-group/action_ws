...
q_home = np.array([-2.02408, -1.06383, 1.8716, -1.80128, 0.00569006, 0.713265,
                   -0.0827766])
q_retract = np.array([-2.02408, -1.06383, 1.8716, -1.80128, 0.00569006, 0.713265,
                      -0.0827766])
q_push = np.array([-2.02408, -1.06383, 1.8716, -1.80128, 0.00569006, 0.713265,
                   -0.0827766])
q_wrap = np.array([-2.02408, -1.06383, 1.8716, -1.80128, 0.00569006, 0.713265,
                   -0.0827766])
